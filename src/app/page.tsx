  ...
  return (
    ...
    <PointerHandler></PointerHandler>
      ...
      <section className="mt-18 bg-amber-200 relative h-[70dvh] justify-center p-10 flex flex-col gap-10">
        <LineLineReveal text={
          <p className="text-5xl md:text-7xl font-black">Welcome to nexStore</p>
        }></LineLineReveal>
      ...
      <section className="bg-amber-100 bg-linear-to-b from-amber-200 to-blue-50 p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 items-center
      [&>div]:sticky [&>div]:md:top-[20%] [&>div]:border [&>div]:border-gray-100
      ">

        <div className="flex flex-col gap-5 shadow-sm bg-white p-8 rounded-2xl top-[20%]">
        ...
        <div className="flex flex-col gap-5 shadow-sm bg-white p-8 rounded-2xl top-[25%]">
        ...
        <div className="flex flex-col gap-5 shadow-sm bg-white p-8 rounded-2xl top-[30%]">
        ...
        <div className="flex flex-col gap-5 shadow-sm bg-white p-8 rounded-2xl top-[35%]">
      ...
      <section className="bg-blue-50 min-h-screen pt-30 flex flex-col justify-center">
        ...
        <div ref={target} className="bg-black relative w-vw h-dvh mt-20 [clip-path:inset(10%_10%_80%_10%)] bg-[url('https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover">
          <div className="absolute bottom-[40%] flex flex-col  gap-5 left-[5%] **:">
            <h3 className="text-6xl md:text-8xl font-bold bg-amber-400 p-2 px-5">
              nexStore
            </h3>
