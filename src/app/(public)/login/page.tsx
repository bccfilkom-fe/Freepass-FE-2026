        ...
        <div className="max-w-9/10">
          ...
          <div className="shadow-xl rounded-2xl flex max-w-4xl max-h-[80dvh] overflow-clip items-center">
            ...
            <div className="md:block hidden w-1/2">
              <img className="" src="https://images.unsplash.com/photo-1721937127582-ed331de95a04?q=80&w=737&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"></img>
            </div>
          </div>
        </div>
      </section>
