        ...
        <div className="max-w-9/10">
          <div className="shadow-xl rounded-2xl flex max-w-4xl max-h-[80dvh] overflow-clip items-center">
            ...
            <div className="md:w-1/2 p-15">
              ...
              <p className="text-sm mt-4 text-black">Create new account now.</p>
              {/* action={formAction} */}
              <form className="flex flex-col gap-4">
                ...
                <button type="submit" className="disabled:opacity-50">
                  {/* pending ? "Memproses..." :  */}
                  <BtnBulat teks={"Register"} btnBg="bg-black" pointerBg="bg-slate-300" border="none" cl="text-white rounded-xl" ></BtnBulat>
                </button>
              </form>
