import { handleEditMovement } from "@//actions/movementActions";
...
export default function EditMovementModal() {
  ...
  const [state, formAction, isLoading] = useActionState(handleEditMovement, {
    success: false,
    message: "",
    errors: {
      product_id: "",
  ...
  return (
    <div className="fixed flex items-center justify-center top-0 left-0 z-50 bg-black/10 backdrop-blur-xs shadow-sm h-screen w-screen" onClick={() => modalStore.closeModal()}>
      <div className="h-fit mx-auto w-9/10 sm:min-w-md sm:max-w-xl shadow-sm py-4 px-6 sm:px-10 bg-white rounded-xl" onClick={(e) => e.stopPropagation()}>
        <div className="my-3">
          <h1 className="text-center text-2xl font-bold text-gray-900 ">Edit Movement Data</h1>
          ...
          ">
              ...
              <div className="flex mt-2 items-center">
                ...
                <div className="relative flex-1">
                  <select
                    ...
                    defaultValue={modalStore.data?.product_id}
                  >
                    {
            ...
            <div className="flex items-center">
              ...
              <div className="flex-1">
                <input defaultValue={modalStore.data?.quantity} required type="number" name="quantity" id="quantity" className="no-spinner flex-1" min={0} />
            ...
            <div className="">
              ...
              <textarea defaultValue={modalStore.data?.note} rows={4} name="note" id="note" className="resize-none" />
