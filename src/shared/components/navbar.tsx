...
export function Navbar() {
    ...
    return (
        <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60">
            <nav className="w-full px-4 sm:px-6 lg:px-8 flex h-16 items-center justify-between gap-4">
                <Link
                    href="/products"
                    ...
                    {navLinks.map((link) => {
                        ...
                        return (
                            <Link
                                ...
                                href={link.href}
                                className={cn(
                                    'relative flex items-center gap-2 px-3 py-2 rounded-md text-sm md:text-base font-medium transition-colors hover:text-primary hover:bg-muted/50',
