...
import { getOrderFeedbackMock, submitFeedbackMock } from './_mock/feedback.mock';
import { getOrderFeedbackReal, submitFeedbackReal } from './_real/feedback.real';
 ...
 * Automatically switches between mock and real API based on ENABLE_MOCK
 */
export const getOrderFeedback = createRpc(getOrderFeedbackMock, getOrderFeedbackReal);
